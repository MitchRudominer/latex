...
of the rotation by $\theta$ radians about the axis $\vec{v}$; equivalently the rotatoin of
$-\theta$ radians about the axis $-\vec{v}$; equivalently the rotation of $2\pi - \theta$ radians
about the axis $-v$.
...
\begin{itemize}
\item $q$ is northern iff $0\leq\varphi<\frac{\pi}{2}$. In this case define:
  \begin{itemize} 
  ...
  \end{itemize}
\item $q$ is southern iff $\frac{\pi}{2}<\varphi\leq\pi$. In this case define: 
  \begin{itemize}
   ...
   \end{itemize}
\item $q$ is equitorial iff $\varphi=\frac{\pi}{2}$. In this case define:
  \begin{itemize}
...
\begin{itemize}
\item The interior of $B_{\text{right}}$ represents the northern hemisphere of $\S^3$ with the origin
representing the north pole.
\item The interior of $B_{\text{left}}$ represents the southern hemisphere of $\S^3$
with the origin representing the south pole.
...
the rotation by $\theta=2\varphi$ radians about $\vec{v}$, for $0\leq\varphi<\frac{\pi}{2}$, and $0\leq\theta<\pi$,
with the origin of $B$ representing the identity rotation.
\item The points $\vec{v}$ and $-\vec{v}$
on the boundary sphere of $B$ represent the rotation of $\pi$ radians about $\vec{v}$,
equivalently the rotation of $\pi$ radians about $-\vec{v}$.
\item The function $\sigma$ restricted to $B_{\text{right}}$ acts as the identity on $\bar{\B}$.
\item The funciton $\sigma$ restricted to $B_{\text{left}}$ acts as the antipodal map on $\bar{\B}$.
\item The point in $\R\P^3$ represented by $\sin(\varphi)\vec{v}$ in the interior of $B$ has two inverse images 
under $\sigma$, the points in $\S^3$ represented by
$\sin(\varphi)\vec{v}\in B_{\text{right}}$ and $-\sin(\varphi)\vec{v}\in B_{\text{left}}$.
\item The point in $\R\P^3$ represented by the pair of  antipodal points $\vec{v}$ and $-\vec{v}$ in the boundary of $B$ has two inverse images under $\sigma$: (1) the point in $\S^3$ represented by
 the pair $\vec{v}$ in  the boundary sphere of $B_{\text{right}}$ and 
  $\vec{v}$ in  the boundary sphere of $B_{\text{left}}$, and (2) the
  point in $\S^3$ represented by the pair
 $-\vec{v}$ in  the boundary sphere of $B_{\text{right}}$ and
  $-\vec{v}$ in  the boundary sphere of $B_{\text{left}}$.
\end{itemize}
...
$a=\mu(A(0)) =\mu(A(2\pi)) = \mu(I)$. Let $b=\mu(A(\pi))$ so that $b$ is the point in the model space of $\R\P^3$ represented by the north and south poles of $B$. The
