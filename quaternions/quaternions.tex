...
By relabelling them if necessary let us assume that $q$ is not southern and
so $0\leq\varphi\leq\frac{\pi}{2}$.
...
$\tau(-A) =-\sin(\varphi) \vec{v}\in B_\text{left}$,
 $\mu(X) = \sin(\varphi) \vec{v}\in B$.

 Next take the case that $q$ and $-q$ are equitorial.
 Define $\tau(A) =\vec{v}$ in the boundary sphere of $B_\text{right}$,
...
which is the same as $\tau(-A) =\vec{-v}$ in the boundary sphere of $B_\text{left}$,
since we identify these points in the quotient space model of $\S^3$.
Define $\mu(X) = \vec{v}$ in the boundary sphere of $B$ which is the same as
$\mu(X) = \vec{-v}$ in the boundary sphere of $B$ since 
