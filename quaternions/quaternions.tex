...
Let $\theta=2\varphi$
so $0\leq\varphi\leq 2\pi$. Notice that $2(\pi-\varphi) = -\theta + 2\pi$.
Let $A=\pi(Q(q))=\pi(Q(-q)\in\SO(3)$. Recall that $A$ is the matrix
of the rotation by $\theta$ radians about the axis $v$ and equivalently the matrix of
$-\theta$ radians about the axis $-v$ and equivalently the matrix of $2\pi - \theta$ radians
about the axis $-v$.


We now define $\tau(Q(q))$, and $\sigma(\tau(Q(q))) = \mu(\pi(Q(q)))=\sigma(\tau(Q(-q))) = \mu(\pi(Q(-q)))$,
...
\item The origon of $B_{\text{left}}$ represents the spouth pole of $S^3$.
\item The common boundafy spheres of $B_{\text{left}}$ and $B_{\text{right}}$ represent the equator of $S^3$.
\item The interior of $B$ represents rotations by less then $\pi$ radians about an axis given by the point in the interior.
...
$p_1=\sin(\varphi)\vec{v}\inB_{\text{right}}$ and $p_1=-\sin(\varphi)\vec{v}\inB_{\text{left}}$.
