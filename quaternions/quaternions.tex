...
Let $\varphiprime = \pi-\varphi$.
If $0\leq\varphi<\frac{\pi}{2}$ 
then $\frac{\pi}{2} < \varphiprime \leq \pi$ and in this case
we call $q$ a \emph{right} point and $-q$ a left point.
If $\frac{\pi}{2} < \varphi \leq \pi$ then $0\leq\varphiprime<\frac{\pi}{2}$ 
and in this case we call $q$ a left point and $-q$ a right point.
Otherwise $\varphi =\varphiprime = \frac{\pi}{2}$ and in this case we
say that $q$ and $-q$ are both boundary points. Notice
$q$ is a right point iff the real part of $q$ is positive, a
left point iff the real part of $q$ is negative, and a boundary point
iff the real part of $q$ is zero. By exchanging $q$ and $-q$ if
necessary, let us assume that $0\leq\varphi\leq\frac{\pi}{2}$,
so that $q$ is a right point or a boundary point.

 Let $A=Q(q)\in \SU(2)$ and $X = \pi(A) = \pi(-A) \in  \SO(3)$. 

Define 
$\tau(A) =\sin(\varphi) \vec{v}\in B_\text{right}$,
$\tau(-A) =-\sin(\varphi) \vec{v}\in B_\text{left}$,
 $\mu(B) = \sin(\varphi) \vec{v}\in B$.


 Notice that if $q$ is a boundary point then 
$\tau(A) =\vec{v}$ in the boundary sphere of $B_\text{right}$,
$\tau(-A) = \vec{-v}$ in the boundary sphere of  $B_\text{left}$,
 $\mu(B) =\vec{v}$ in the boundary sphere of  $B$.
Also notice that in this case the choice of which point to
call $q$ and which point to call $-q$
 was arbitrary and if we had made the other choice then we would have
 defined
$\tau(A) =\vec{v}$ in the boundary sphere of $B_\text{left}$,
$\tau(-A) = \vec{-v}$ in the boundary sphere of  $B_\text{right}$,
 $\mu(B) =\vec{-v}$ in the boundary sphere of  $B$.

 This ambiguity is not a problem  for our definition of
 $\tau:\SU(2)\map\S^3$ because $\vec{v}$ in the boundary sphere of 
 $B_\text{left}$ and $\vec{v}$ in the boundary sphere of 
 $B_\text{right}$ map to the same point in the quotent model of $\S^3$,
 and this ambiguity is not a problem for our definition of
 $\mu:\SO(3)\map \R\P^3$ because $\vec{v}$ in the boundary sphere of  $B$
 and $\vec{-v}$ in the boundary sphere of  $B$ map to the same point in
 the quotient model of $\R\P^3$.
