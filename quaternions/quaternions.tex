...
Since $\sigma=\tau^{-1}\circ\pi\circ\mu$, the above analysis can be used to help us visualize $\sigma$.
Write
...
\begin{itemize}
\item $q$ is northern iff $0\leq\varphi<\frac{\pi}{2}$ and then $\tau(Q(q))$ is the point $\sin(\varphi) \vec{v}$  in the interior of $B_{\text{right}}$ and $\sigma(\tau(Q(q)))$ is the point $\sin(\varphi) \vec{v}$ in the interior of $B$.
\item $q$ is southern iff $\frac{\pi}{2}<\varphi\leq\pi$ and then $\tau(Q(q))$ is the point $\sin(\varphi) \vec{v}$ in the interior of $B_{\text{left}}$ and $\sigma(\tau(Q(q)))$ is the point $-\sin(\varphi) \vec{v}$ in the interior of $B$.
\item $q$ is equitorial iff $\varphi=\frac{\pi}{2}$ and then $\tau(Q(q))$ is (the image under the quotient map of)
the two points $\vec{v}$ in the boundary spheres of
$B_{\text{left}}$ and $B_{\text{right}}$ and $\sigma(\tau(Q(q)))$ is (the image under the quotient map of) the two
points $\vec{v}$ and $-\vec{v}$ in the boundar sphered of $B$.
\end{itemize}
