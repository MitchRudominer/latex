...
With this multiplication and inverse, in addition to the
standard vector space structure,
$\R^4$ becomes a real associative division algebra we call the quaternions.
...
We can tell from context that the symbols 0 and 1 refer to
