...
which equals $|q|^2$ times the identity quaternion.
\end{proof}
...
that distributes over addition, commutes with scalar multiplication,
 ...
 \begin{remarks} All of $\R$, $\R^3$ and $\C$ naturally embed into $\H$ and going forward we will often
 tacitly conflate all of these with their images in $\H$.
 \begin{enumerate}
 \item We will identify $\R$ with the scalar quaternions via the identification $x\mapsto x 1$ where $x$ is a
