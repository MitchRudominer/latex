...
\item The point in $\R\P^3$ represented by the pair of  antipodal points $\vec{v}$ and $-\vec{v}$ in the boundary of $B$ has two inverse images under $\sigma$, the point in $\S^3$ represented by
 $\vec{v}$ in  the boundary sphere of $B_{\text{right}}$ and 
  $\vec{v}$ in  the boundary sphere of $B_{\text{left}}$, and the
  point in $\S^3$ represented by
 $-\vec{v}$ in  the boundary sphere of $B_{\text{right}}$ and
