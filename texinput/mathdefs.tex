...
\newcommand{\Wadgeleq}{\leq_{\text{W}}}
\newcommand{\Wadgeless}{<_{\text{W}}}
...
\DeclareMathOperator{\semiproper}{sp}
...
\newcommand{\varphiprime}{\varphi^{\prime}}
...
%        twiddle Letters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\atwiddle}{\tilde{a}}
\newcommand{\btwiddle}{\tilde{b}}
...
\newcommand{\bPiOneOmega}{\bPi^1_{\omega}}
