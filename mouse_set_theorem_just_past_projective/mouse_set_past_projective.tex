...
Let $\tau\in M$ be such that $x=\tau^{g_1}$. By hypothesis $M[g_1\times g_2]$ is $\Sigma^1_n$-correct
...
Then $M[h\times h_2]\models \neg E(\tau^{h_1},\tau^{h_2})$ and $M[h\times h_2]$ is $\Sigma^1_n$-correct so $\neg E(\tau^{h_1},\tau^{h_2})$.
\end{subproof}
...
A similar argument appears in the proof of Lemma 3.1 of \cite{Schlict_Thin_Equivalence_Relations}.
