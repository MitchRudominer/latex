...
all generic extensions of a $\Sigma^1_n$-correct, countable, transitive model of Set Theory
meet the same equivalence classes of a thin, $\Sigma^1_n$ equivalence
relation.
...
\begin{lemma}[Hjorth]
\label{hjorthlemma}
Let $M$ be a countable, transitive, $\Sigma^1_n$-correct model of $\ZFC$.
Let $\delta>\omega$ be a cardinal of $M$, and let $g_1$ and $g_2$ be $M$-generic
for $\Col(\omega, \delta)$. Let $E\subset\R^2$ be a $\Sigma^1_n$, thin equivalence relation.
...
Since $J^M_{\gamma_{2n+2}}$ is $\Sigma^1_{2n+4}$-correct, and $y\in J^M_{\gamma_{2n+2}}[g_{2n+2}]$,
we may now apply Hjorth's Lemma \ref{hjorthlemma} to conclude that if $g$ is any $\Col(\omega,\delta_{2n+2})$-generic over $J^M_{\gamma_{2n+2}}$,
then there is a $\yprime\in J^M_{\gamma_{2n+2}}[g]$ such that $E(y,\yprime)$.


Since $J^M_{\gamma_{2n+2}}$ is countable in $M^*$, there is such a $\yprime\in M^*$. This is
