...
One of the key technical ideas of the paper is that, even though
...
of Woodins in $\Mladder$. A primary example of this idea is Lemma
...
\item $a_{n+1} < a_n$,
\item For $m,k \leq n$, there is an $e\in D^m_k$ such that $a_{n+1}<e$.
\end{itemize}
