...
we can perform the usual genericity iteration on $J^M_{\gamma_0}$, yielding
...
over $M$. So the $\pibar_0$-iteration of $J^M_{\gamma_0}$ induces a corresponding iteration on all of $M$
yielding a non-dropping iteration $\pi_0:M\to \Mprime_1$ such that
letting $\sequence{\delta_{n,1},\gamma_{n,1}}{n\in\omega}$ be the image under $\pi_0$
of the ladder of $M$, we have that $\Mprime_1$ is a countable, iterable ladder-mouse
with $\sequence{\delta_{n,1},\gamma_{n,1}}{n\in\omega}$ a ladder over $\Mprime_1$
and there is a $g_0$ such that $g_0$
is $\Col(\omega,\delta_{0,1})$-generic over
$J^{\Mprime_1}_{\gamma_{0,1}}$ and $y\in J^{\Mprime_1}_{\gamma_{0,1}}[g_0]$.

Now we repeat the argument of the previous two paragraphs using $\Mprime_1$ instead of $M$
and using $\delta_{1,1}$ in place of $\delta_0$. This yields a non-dropping iteration
$\pi_1:\Mprime_1\to\Mprime_2$. We can take the critical point of $\pi_1$ to be
greater than $\gamma_{0,1}$. Then,
letting $\sequence{\delta_{n,2},\gamma_{n,2}}{n\in\omega}$ be the image under $\pi_1$
of the ladder of $\Mprime_1$, we have that $\Mprime_2$ is a countable, iterable ladder-mouse
with $\sequence{\delta_{n,2},\gamma_{n,2}}{n\in\omega}$ a ladder over $\Mprime_2$
and for $n=0,1$ there is a $g_n$ such that $g_n$
is $\Col(\omega,\delta_{n,2})$-generic over
$J^{\Mprime_2}_{\gamma_{n,2}}$ and $y\in J^{\Mprime_2}_{\gamma_{n,2}}[g_n]$.
...
The proof of Lemma \ref{hjorthlemma} is based on similar arguments by Greg Hjorth, Lemma 2.2 from \cite{Hjorth_applications_of_course_imt}, and Foreman and Magidor, Theorem 3.4 of \cite{Foreman_and_Magidor}.
