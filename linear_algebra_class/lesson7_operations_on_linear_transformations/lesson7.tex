...
\item $T_A + T_B$.
\item Let $f$ and $g$ be any two functions from $\R^m$ to $\R^n$.
...
\item $c T_A$.
\item Let $f$ be any function from $\R^m$ to $\R^n$.
