...
\begin{frame}{Properties of matrix multiplication (2)}
...
\begin{frame}{Properties of matrix multiplication (3)}
...
\begin{frame}{Properties of matrix multiplication (4)}
...
\item Let $A$ be $n\times m$, $B$ be $m\times k$, $C$, $k\times l$.
...
\begin{frame}{Properties of matrix multiplication (5)}
