...
\begin{theorem}[Davis, 1964 + Solovay, Kechris, Martin early 1970's]
$\bPi^1_n$ determinacy implies all $\bSigma^1_{n+1}$ sets have the perfect set
property.
\end{theorem}

\begin{theorem}[Mycielski-Swierczkowski, 1964 + Solovay, Kechris, Martin early 1970's]
...
\begin{theorem}[Martin,Steel 1985]
